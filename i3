...
# start a terminal
bindsym $mod+Return exec termite -e tmux attach
...
set $Locker i3lock -i ~/Pictures/Wallpaper/wallhaven-116298.png && sleep 1
...
exec --no-startup-id feh --randomize --bg-center ~/Pictures/Wallpaper/*
